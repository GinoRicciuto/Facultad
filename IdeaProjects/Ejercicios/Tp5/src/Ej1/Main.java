...
public class Main {
    public static void main(String[] args){
        ...
        CentroComputo nuevoCentro = new CentroComputo();
        Computadora nuevapc = new Computadora("LG",1);
        nuevoCentro.agregarComputadora(nuevapc);
        Tarea nuevaTarea = new Tarea("compra",30);
